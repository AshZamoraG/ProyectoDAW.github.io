...
(NULL, 'Camiseta de algodón', 'Camiseta cómoda para el día a día', ' H&M ', 'M', 15.99, 100, 'RPH_CAM_01', 1),
(NULL, 'Vestido de verano', 'Vestido fresco para el verano', 'Zara', 'M', 39.99, 80, 'RPM_VES_02', 2),
(NULL, 'Pantalón de mezclilla', 'Pantalón casual', ' H&M ', '32', 29.99, 50, 'RPN_PAM_03', 3),
(NULL, 'Pantaloneta de algodon', 'Pantaloneta comoda para una mayor movilidad', 'Nike', 'S', 24.99, 30, 'RUG_DEP_04', 4),
(NULL, 'Sujetador de Encaje', 'Sujetador elegante y cómodo', 'Victoria Secret', 'M', 25.99, 50, 'ROP_INT_001', 5),
(NULL, 'Collar de Plata', 'Collar fino y delicado', 'Tiffany & Co.', 'Única', 99.99, 30, 'ACC_002', 6),
(NULL, 'Zapatillas Nike Air Max', 'Zapatillas cómodas para correr', 'Nike', '42', 129.99, 20, 'CAL_003', 7),
(NULL, 'Cortina Estampada', 'Cortina decorativa para el hogar', 'IKEA', 'Única', 39.99, 40, 'ART_HOG_004', 8);
